...
public class CameraTouchcController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.touchCount == 1 && touch0.phase == TouchPhase.Moved)
        {
            ...
            //TO Do clamp targetPos
            targetPos = new Vector3(Mathf.Clamp(targetPos.x,topCollider.bounds.min.x,topCollider.bounds.max.x),targetPos.y,Mathf.Clamp(targetPos.z,topCollider.bounds.min.z,topCollider.bounds.max.z));
        ...
        if(touch0.phase == TouchPhase.Moved || touch1.phase == TouchPhase.Moved)
        {
            ...
            var currDistance = Vector3.Distance(touch0PrevPos, touch1PrevPos);
